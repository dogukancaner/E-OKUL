...
namespace BonusOkulProje.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BonusOkulProje.Properties.Settings.Default.BonusOkulConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRSOYAD, TBLOGREN" +
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRSOYAD, TBLOGRENCILER.OGRCINSIYET, TBLKULUPLER.KULUPAD
FROM     TBLOGRENCILER INNER JOIN
                  TBLKULUPLER ON TBLOGRENCILER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE  (TBLOGRENCILER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO TBLOGRENCILER\r\n                  (OGRAD, OGRSOYAD, OGRKULUP, OGRCINSI" +
                "YET)\r\nVALUES (@OGRAD,@OGRSOYAD,@OGRKULUP,@OGRSINSIYET)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRSINSIYET", global::System.Data.SqlDbType.VarChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCINSIYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int OgrenciEkle(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, string OGRSINSIYET) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((OGRSINSIYET == null)) {
                ...
                command.Parameters[3].Value = ((string)(OGRSINSIYET));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
